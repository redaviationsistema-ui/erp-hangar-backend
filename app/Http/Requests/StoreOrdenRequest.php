...
class StoreOrdenRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'tareas.*.foto_path' => 'nullable|string|max:255',
            ...
            'discrepancias.*.imagen_path' => 'nullable|string|max:255',
    ...
    private function ndtRules(): array
    {
        return [
            ...
            'ndt.*.evidencia_path' => 'nullable|string|max:255',
    ...
    private function tallerRules(): array
    {
        return [
            ...
            'talleres_externos.*.foto_path' => 'nullable|string|max:255',
    ...
    private function medicionRules(): array
    {
        return [
            ...
            'mediciones.*.imagen_path' => 'nullable|string|max:255',
